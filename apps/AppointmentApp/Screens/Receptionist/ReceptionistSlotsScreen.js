...
const ReceptionistSlotsScreen = ({ navigation }) => {
    ...
    const SlotsHeader = () => {
        return (
            <View style={sstyles.AHeader}>
                ...
                <TouchableOpacity
                    onPress={() => {
                        navigation.navigate('ReceptionistAddSlots', {
                            type: 'Add',
                            doctorId: doctorId
                        })
                    }}
                                                ...
                                                <View style={sstyles.TimelineArea}>
                                                    <View style={sstyles.TimelineTitle}>
                                                        ...
                                                        <TouchableOpacity 
                                                            ...
                                                            onPress={() => navigation.navigate('ReceptionistAddSlotsTb', {
                                                                name: "Slot",
                                                                type: 'Add',
                                                                id: item.id
                                                            })}
...
export default ReceptionistSlotsScreen;