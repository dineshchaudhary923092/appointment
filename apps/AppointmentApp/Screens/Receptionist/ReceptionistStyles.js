...
export default EStyleSheet.create({
    ...
    Bbox: {
        flexDirection: 'row',
        margin: deviceType === 'Tablet' ? '10.5rem' : '15rem',
        backgroundColor: '#fff',
        padding: deviceType === 'Tablet' ? '7rem' : '10rem',
        borderRadius: deviceType === 'Tablet' ? '5rem' : '8rem',
    },
    BboxImg: {
        flex: 1.5,
        height: deviceType === 'Tablet' ? '66.5rem' : '95rem',
        borderRadius: deviceType === 'Tablet' ? '5rem' : '8rem',
        marginRight: deviceType === 'Tablet' ? '7rem' : '10rem',
    },
    BboxInner: {
    ...
    DateWrapper: {
        marginLeft: deviceType === 'Tablet' ? '10.5rem' : '15rem',
        marginVertical: deviceType === 'Tablet' ? '10.5rem' : '15rem',
    ...
    DateNum: {
        ...
        fontFamily: 'Roboto-Bold',
        color: Colors.dark,
        paddingTop: deviceType === 'Tablet' ? '3.3rem' : '5rem',
        letterSpacing: -0.2
    },
    SlotWrapper: {
        margin: deviceType === 'Tablet' ? '4rem' : '6rem',
        shadowColor: "#000",
        shadowOffset: {
            width: 0,
            height: '2rem',
        ...
        shadowOpacity: 0.1,
        shadowRadius: 3.84,
        elevation: deviceType === 'Tablet' ? '3.3rem' : '5rem',
    },
    SlotWrapperInner: {
    ...
    SlotsCount: {
        textAlign: 'center',
        fontSize: deviceType === 'Tablet' ? '8.3rem' : '12rem',
        fontFamily: 'Roboto-Medium',
        opacity: 0.35,
